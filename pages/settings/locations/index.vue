...
<script setup>  
    ...
    const pageTotal = computed(() => positions.value.length )
    const pageTo = computed(() => Math.min(page.value * pageCount.value, pageTotal.value))

    // Data
    const { data: positions, pending, refresh } = await useAsyncData('positions', async () => await postApi('/bk/type/ListData' , {
            TypeKey: "POSITION",
    ...
    const dataForm = {
        type_key:"POSITION",//VEHICLE , REASON , POSITION
        type_id: genID(),
